...
const string strMessageMagic = "OmiseGOClassic Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OmiseGOClassic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1512117421, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Republicans Clear Major Hurdle as Tax Bill Advances";
        CTransaction txNew;
        txNew.nTime = 1512117421;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1512117421;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1234233 : 1234233;
        ...
        assert(block.hashMerkleRoot == uint256("0x2926a9768c31de1857a0b08494645b98b9c214fb5bce62022e5fa27cb3f374db"));
...
unsigned char pchMessageStart[4] = { 0xe2, 0x65, 0x0b, 0x50 };
